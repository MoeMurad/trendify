...
const users: IUserInput[] = [
    ...
    {
        name: 'Braa',
        email: 'braa@example.com',
        password: bcrypt.hashSync('123456', 5),
        role: 'User',
        address: {
            fullName: 'Braa Darraj',
            street: '111 Main St',
            city: 'New York',
            province: 'NY',
            postalCode: '10001',
    ...
    {
        name: 'Rhainna',
        email: 'rhainna@example.com',
        password: bcrypt.hashSync('123456', 5),
        role: 'User',
        address: {
            fullName: 'Rhainna Zulkifli',
            street: '111 Main St',
            city: 'New York',
            province: 'NY',
            postalCode: '10001',
